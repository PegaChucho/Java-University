 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://servicio.sga.pegachucho.com.mx/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://servicio.sga.pegachucho.com.mx/", "PersonaServiceImplService");
    ...
    public PersonaServiceWS getPersonaServiceImplPort() {
        return super.getPort(new QName("http://servicio.sga.pegachucho.com.mx/", "PersonaServiceImplPort"), PersonaServiceWS.class);
    }
    ...
    public PersonaServiceWS getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.sga.pegachucho.com.mx/", "PersonaServiceImplPort"), PersonaServiceWS.class, features);
    }
